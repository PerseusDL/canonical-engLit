...
<!-- 
    This stylesheet processes Schmidt Shakespeare lexicon -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:publicationStmt">
        <publicationStmt xmlns="http://www.tei-c.org/ns/1.0">
            ...
            <idno type="filename">schmidt.lexicon.perseus-eng1.xml</idno>
            <availability>
    ...
    <xsl:template match="tei:body">
        <body xmlns="http://www.tei-c.org/ns/1.0">
            <div type="edition" xml:lang="eng"
                n="urn:cts:engLit:schmidt.lexicon.perseus-eng1">
            <xsl:apply-templates/>
            </div>
        </body>
    </xsl:template>
    ...
    <xsl:template match="tei:div1">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="alpha">
            <xsl:choose>
                <xsl:when test="@n">
    ...
    <xsl:template match="tei:refsDecl">
        <refsDecl xmlns="http://www.tei-c.org/ns/1.0" n="CTS">
            <cRefPattern n="section" matchPattern="(\w+)"
                replacementPattern="#xpath(//tei:div[@subtype='alpha' and @n='$1')">
                <p>This pattern matches alphabetic section.</p>
            </cRefPattern>
    ...
    <xsl:template match="tei:dateStruct">
    <date xmlns="http://www.tei-c.org/ns/1.0">
    ...
    <xsl:template match="tei:year | tei:month | tei:day">
        <xsl:apply-templates />
    </xsl:template>
    ...
    <xsl:template match="tei:measure">
        <measure xmlns="http://www.tei-c.org/ns/1.0">
            <xsl:choose>
                <xsl:when test="@reg">
    ...
    <xsl:template match="tei:corr">
        <choice xmlns="http://www.tei-c.org/ns/1.0">
            <sic><xsl:value-of select="@sic"/></sic>
