...
<!-- 
    This stylesheet processes Marlowe's plays-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:front/tei:div1[@type='versions']">
    ...
    <xsl:template match="tei:body/tei:div1">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="act">
    ...
    <xsl:template match="tei:body/tei:div1/tei:div2">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="scene">
            <xsl:attribute name="n">
    ...
    <xsl:template match="tei:prologue">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="prologue">
            <xsl:attribute name="n">
    ...
    <xsl:template match="tei:refsDecl">
        <refsDecl xmlns="http://www.tei-c.org/ns/1.0" n="CTS">
            <cRefPattern n="asl" matchPattern="(\w+).(\w+).(\w+)"
                ...
                <p>This pointer pattern extracts act, scene, and line.</p>
            </cRefPattern>
    ...
    <xsl:template match="tei:revisionDesc">
        <revisionDesc xmlns="http://www.tei-c.org/ns/1.0">
            <change>
                <ab>converted to Perseus Drama</ab>
            </change>
        </revisionDesc>
    </xsl:template>
    ...
    <xsl:template match="tei:language">
        <language xmlns="http://www.tei-c.org/ns/1.0">
            <xsl:choose>
                ...
                <xsl:when test="@id = 'es'">
                    <xsl:attribute name="ident">spa</xsl:attribute>
                </xsl:when>
    ...
    <xsl:template match="tei:tagStart">
        <tag xmlns="http://www.tei-c.org/ns/1.0" type="start">
            <xsl:value-of select="@gi"/>
        </tag>
    </xsl:template>

    <xsl:template match="tei:tagEnd">
        <tag xmlns="http://www.tei-c.org/ns/1.0" type="end">
            <xsl:value-of select="@gi"/>
        </tag>
    </xsl:template>
