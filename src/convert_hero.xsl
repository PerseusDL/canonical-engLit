...
<!-- 
    This stylesheet processes Hero and Leander-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:body/tei:div1">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="part">
    ...
    <xsl:template match="tei:div2">
        ...
        <xsl:variable name="nvalue" select="@n"/>
        <xsl:analyze-string select="$nvalue" regex="sestyad\s+(\d)">
            <xsl:matching-substring>
                <xsl:attribute name="subtype">sestyad</xsl:attribute>
                <xsl:attribute name="n">
    ...
    <xsl:template match="tei:refsDecl">
        <refsDecl xmlns="http://www.tei-c.org/ns/1.0" n="CTS">
            ...
            <cRefPattern n="sestyad" matchPattern="([0-6])"
                replacementPattern="#xpath(//div[@subtype='sestyad' and @n='$1'])">
                <p>This pointer pattern extracts act.</p>
            </cRefPattern>
            <cRefPattern n="sestyad line" matchPattern="([0-6]).(\w+)"
                replacementPattern="#xpath(//div[@subtype='sestyad' and @n='$1']//l[@n='$2])">
                <p>This pointer pattern extracts act.</p>
            </cRefPattern>
        </refsDecl>
