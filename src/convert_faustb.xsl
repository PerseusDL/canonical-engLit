...
<!-- 
    This stylesheet processes Marlowe's Faust B version-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:join">
        ...
        <join xmlns="http://www.tei-c.org/ns/1.0">
    ...
    <xsl:template match="tei:epilogue">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="epilogue">
            <xsl:apply-templates />
        </div>
    </xsl:template>
