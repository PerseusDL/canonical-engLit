...
<!-- 
    This stylesheet processes Wilson, Arte of Rhetorique-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:front/tei:div1">
    ...
    <xsl:template match="tei:front/tei:div1/tei:div2">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart">
            <xsl:attribute name="subtype">
    ...
    <xsl:template match="tei:body/tei:div1">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="book">
            <xsl:attribute name="n">
                <xsl:value-of select="count(preceding-sibling::tei:div1) + 1"/>
            </xsl:attribute>
            <xsl:apply-templates/>
        </div>
    </xsl:template>
    
    <xsl:template match="tei:body/tei:div1/tei:div2">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="section">
            <xsl:attribute name="n">
                <xsl:value-of select="count(preceding-sibling::tei:div2) + 1"/>
            </xsl:attribute>
            <xsl:apply-templates/>
        </div>
    </xsl:template>
    
    <xsl:template match="tei:body/tei:div1/tei:div2/tei:div3">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="paragraph">
            <xsl:attribute name="n">
    ...
    <xsl:template match="tei:body/tei:div1/tei:div2/tei:div3/tei:div4">
        <div xmlns="http://www.tei-c.org/ns/1.0" type="textpart" subtype="subparagraph">
            <xsl:attribute name="n">
                <xsl:value-of select="count(preceding-sibling::tei:div4) + 1"/>
            </xsl:attribute>
            <xsl:apply-templates/>
        </div>
    </xsl:template>
    ...
    <xsl:template match="tei:refsDecl">
        <refsDecl xmlns="http://www.tei-c.org/ns/1.0" n="CTS">
            <cRefPattern n="section" matchPattern="(\w+).(\w+).(\w+)"
                replacementPattern="#xpath(/tei:TEI/tei:text/tei:body//tei:div[@subtype='book' and @n='$1'/tei:div[@n='$2']/tei:div[@n='$3'])">
                <p>Book, section, paragraph.</p>
            </cRefPattern>
            <cRefPattern n="section" matchPattern="(\w+).(\w+)"
                replacementPattern="#xpath(/tei:TEI/tei:text/tei:body//tei:div[@subtype='book' and @n='$1'/tei:div[@n='$2'])">
                <p>Book, section.</p>
            </cRefPattern>
        </refsDecl>
    </xsl:template>
