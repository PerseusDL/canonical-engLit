...
<!-- 
    This stylesheet processes the EFB -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:body">
        <body xmlns="http://www.tei-c.org/ns/1.0">
            <div type="edition" xml:lang="eng"
                n="urn:cts:engLit:efb.efb.perseus-eng1">
            <xsl:apply-templates/>
            </div>
        </body>
    </xsl:template>
    ...
    <xsl:template match="tei:refsDecl">
        <refsDecl xmlns="http://www.tei-c.org/ns/1.0" n="CTS">
            <cRefPattern n="part_chapter" matchPattern="(\w+).(\w+)"
                replacementPattern="#xpath(//tei:div[@subtype='part' and @n='$1']/tei:div[@subtype='chapter' and @n='$2'])">
    ...
    <xsl:template match="tei:revisionDesc">
        <revisionDesc xmlns="http://www.tei-c.org/ns/1.0">
            <list>
                <item>converted to epidoc.rng</item>
            </list>
        </revisionDesc>
    </xsl:template>
    ...
    <xsl:template match="tei:note">
        <note xmlns="http://www.tei-c.org/ns/1.0">
            ...
            <xsl:apply-templates select="@anchored" />
            <xsl:apply-templates />
        </note>
    </xsl:template>
